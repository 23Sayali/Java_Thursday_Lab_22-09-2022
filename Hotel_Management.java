		...
		public static void main(String args[]) 
		{
			...
			do
			{
				...
				case 1:
					...
					System.out.println("2: Panner Pakoda \t 300Rs.");
					System.out.println("3: Corn Thikki  \t 250Rs.");
					order = s.nextInt();
					if(order==1) 
					{
						 ...
						 if(count<req)                                     
						 {
						item_amt = item_amt + 150;              // addition of 2 quantity
						 item_amt = item_amt * req;               //amount*quantity
					...
					else if(order==2)
					{
						System.out.println("Enter Quantity : ");
						 ...
						 if(count<req)
						 {
						 item_amt = item_amt + 300;          // addition of 2 quantity
						 item_amt = item_amt * req;           //amount*quantity
						 item_name+="\n STARTERS - Panner Pakoda";
						 }
					}
					else 
					{
						System.out.println("Enter Quantity : ");
						 ...
						 if(count<req)
						 {
						 item_amt = item_amt + 250;             // addition of 2 quantity
						 item_amt = item_amt * req;              //amount*quantity
						 item_name+="\n STARTERS - Corn Thikki ";
						 }
					}
					break;
				case 2:
					...
					System.out.println("2: Aloo Matar \t\t 520Rs.");
					...
					if(order==1) 
					{
						System.out.println("Enter Quantity : ");
						 ...
						 if(count<req)
						 {
						 item_amt = item_amt + 480;          // addition of 2 quantity
						 item_amt = item_amt * req;            //amount*quantity
					...
					else if(order==2)
					{
						System.out.println("Enter Quantity : ");
						 ...
						 if(count<req)
						 {
						 item_amt = item_amt + 520;                    // addition of 2 quantity
						 item_amt = item_amt * req;                     //amount*quantity
						 item_name+="\n MAIN COURSE - Aloo Matar";
						 }
					}
					else
					{
						System.out.println("Enter Quantity : ");
						 ...
						 if(count<req)
						 {
						 item_amt = item_amt + 780;                             // addition of 2 quantity
						 item_amt = item_amt * req;                              //amount*quantity
				...
				case 3:
					...
					System.out.println("1: Gulab Jammun \t160Rs.");
					...
					if(order==1) 
					{
						System.out.println("Enter Quantity : ");
						 ...
						 if(count<req)
						 {
						 item_amt = item_amt + 160;             // addition of 2 quantity
						 item_amt = item_amt * req;              //amount*quantity
						 item_name+="\n DESERTS - Gulab Jammun";
						 }
					}
					else if(order==2)
					{
						System.out.println("Enter Quantity : ");
						 ...
						 if(count<req)
						 {
						 item_amt = item_amt + 180;                     // addition of 2 quantity
						 item_amt = item_amt * req;                       //amount*quantity
						 item_name+="\n DESERTS - Ice Cream";
						 }
					}
